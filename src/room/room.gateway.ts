import { OnGatewayDisconnect, OnGatewayConnection, OnGatewayInit, SubscribeMessage, WebSocketGateway, WebSocketServer} from '@nestjs/websockets';
...
@WebSocketServer() wss: Server;
  ...
  async handleJoin (client: Socket, payload: JoinRoomDto){
    ...
    const existingOnSocket = this.activeSockets.find(
      ...
      if(!existingOnSocket){
        this.activeSockets.push({ room: link, id: client.id, userId, string: undefined });
